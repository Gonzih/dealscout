...
// ── Tool: scout_listings ───────────────────────────────────────────────────
server.tool("scout_listings", `Scrape BizBuySell and BizQuest for active business-for-sale listings.
...
server.tool("lookup_business_sos", `Look up a business entity in the Secretary of State database.
...
server.tool("get_sba_loan_data", `Query public SBA 7(a) loan FOIA data by zip code and NAICS code.
...
server.tool("estimate_valuation", `Calculate acquisition valuation range using sector-specific SDE multiples.
...
// ── Tool: structure_deal ───────────────────────────────────────────────────
server.tool("structure_deal", `Model tax-efficient acquisition structures with SBA 7(a) financing and seller notes.
...
server.tool("research_comparables", `Find recent comparable small business PE transactions and implied multiples.
...
server.tool("intelligent_scout", `Natural language deal intelligence orchestrator — START HERE for most queries.
