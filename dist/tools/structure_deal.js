...
export function structureDeal(params) {
    ...
    const sbaLoanAmount = Math.round(Math.min(purchase_price - minEquity - sellerNoteAmount, maxSbaLoan));
    ...
    const annualDepreciationShield = Math.round(bonusDeduction + regularDepreciation + goodwillAmortization);
    // ── DSCR Estimate ────────────────────────────────────────────────────────
...
//# sourceMappingURL=structure_deal.js.map