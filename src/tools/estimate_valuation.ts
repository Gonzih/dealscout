...
function normalizeSector(sector: string): string {
  ...
  if (s.includes("hvac") || s.includes("heating") || s.includes("cooling") || s.includes("air conditioning")) return "hvac";
  if (s.includes("mechanical")) return "mechanical";
  if (s.includes("plumb")) return "plumbing";
  if (s.includes("electric")) return "electrical";
  if (s.includes("pest") || s.includes("extermination") || s.includes("termite")) return "pest_control";
  if (s.includes("landscape") || s.includes("lawn") || s.includes("tree")) return "landscaping";
  if (s.includes("roof")) return "roofing";
  if (s.includes("clean") || s.includes("janitor") || s.includes("maid")) return "cleaning";
  return "general";
}

export function estimateValuation(params: EstimateValuationParams): ValuationResult {
